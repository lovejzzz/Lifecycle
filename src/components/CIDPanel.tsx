...
function renderMarkdown(text: string, nodeNames?: Map<string, string>, onNodeClick?: (id: string) => void): React.ReactNode {
  if (!text) return null;
...
function inlineFormat(text: string, nodeNames?: Map<string, string>, onNodeClick?: (id: string) => void): React.ReactNode {
