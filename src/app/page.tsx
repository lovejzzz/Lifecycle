        ...
        {toasts.map((toast) => {
          ...
          return (
            <motion.div
              ...
              className={`pointer-events-auto flex items-center gap-2.5 rounded-xl border px-4 py-2.5 ${style.border} ${style.bg} shadow-2xl backdrop-blur-xl`}
            >
              ...
              <button
                ...
                className="ml-1 text-white/20 hover:text-white/50"
              >
                <X size={12} />
              </button>
            </motion.div>
...
export default function Home() {
  return (
    <ErrorBoundary>
      <div className="relative flex h-screen w-screen flex-col overflow-hidden bg-[#08080d]">
